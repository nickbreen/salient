...
wp_enqueue_style( 'localist-custom', get_stylesheet_directory_uri() . '/localist-custom.css' );
}
...
//     echo '<div id="some_custom_checkout_field"><h2>' . __('Extra Passengers') . '</h2>';
 
//     woocommerce_form_field( 'terms', array(
//         'type'          => 'checkbox',
//         'class'         => array('my-field-class form-row-wide'),
//         'label'         => __('<a href="/manatours/terms" target="_blank">Terms & Conditions</a>'),
//         'placeholder'   => __(''),
//         'required'      => true,
...
// 		wp_redirect( 'http://www.test-webhost.orahq.com/manatours/passengers' );
// 		exit;
// 	}
// }
